...
function createBoxOfTiles(x, y, w, h, tilePath, tileSize, tileResolution) {
    ...
    for (let i = 0; i < xLength; i++) {
        for (let j = 0; j < yLength; j++) {
            new spriteObj(i * tileSize + x, j * tileSize + y, tileSize, tileSize, tilePath, tileResolution, tileResolution, 0, false);
        }
    }
}
...
for (let i = 0; i < 3; i++) {
    for (let j = 0; j < 3; j++) {
        new box(i * 50 + 300, j * 50 + 300, 40, 40, 'rgba(0, ' + i * 20 + 100 + ', ' + j * 20 + 100 + ', 1)', true);
    }
}
...
createBoxOfTiles(0, 0, 1200, 32, 'assets/textures/blueTile.png', 32, 16);
createBoxOfTiles(0, 0, 32, 1200, 'assets/textures/blueTile.png', 32, 16);
createBoxOfTiles(0, 1200 - 32, 1200, 32, 'assets/textures/blueTile.png', 32, 16);
createBoxOfTiles(1200 - 48, 0, 32, 1200, 'assets/textures/blueTile.png', 32, 16);